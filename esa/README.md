...
```plain
docker run -t -v ./output:/projects/data/output esa-get-dem --bbox 'LEFT BOTTOM RIGHT TOP' --compute BOOLEAN
```
...
```plain
docker run -t -v ./output:/projects/data/output esa-get-dem --bbox '-118.06817 34.22169 -118.05801 34.22822' --compute true
```
...
```plain
docker run -t -v ./output:/projects/data/output esa-get-dem --bbox '-118.06817 34.22169 -118.05801 34.22822' --compute false
```
